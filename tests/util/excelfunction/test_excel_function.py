...
class TestExcelFunction(unittest.TestCase):
    ...
    def test_attendance_name(self):
        ...
        n3 = ExcelUtil.crete_cell_string(row=3, column='N')
    ...
    def test_text_from_datetime(self):
        ...
        n3 = ExcelUtil.crete_cell_string(row=3, column='N', fixed_row=True, fixed_column=True)
        a16 = ExcelUtil.crete_cell_string(row=16, column='A', fixed_column=True)
    ...
    def test_attendance_time(self):
        ...
        c16 = ExcelUtil.crete_cell_string(row=16, column='C', fixed_column=True)
        n7 = ExcelUtil.crete_cell_string(row=7, column='N', fixed_row=True, fixed_column=True)
    ...
    def test_overtime_hours(self):
        ...
        J16 = ExcelUtil.crete_cell_string(row=16, column='J', fixed_column=True)

        D16 = ExcelUtil.crete_cell_string(row=16, column='D', fixed_column=True)
        E16 = ExcelUtil.crete_cell_string(row=16, column='E', fixed_column=True)
        F16 = ExcelUtil.crete_cell_string(row=16, column='F', fixed_column=True)
        G16 = ExcelUtil.crete_cell_string(row=16, column='G', fixed_column=True)
    ...
    def test_working_hours(self):
        ...
        F16 = ExcelUtil.crete_cell_string(row=16, column='F', fixed_column=True)
        G16 = ExcelUtil.crete_cell_string(row=16, column='G', fixed_column=True)
        H16 = ExcelUtil.crete_cell_string(row=16, column='H', fixed_column=True)
